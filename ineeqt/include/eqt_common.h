...
* \file
*
* This header provides macros shared across the entire extra Qt API.
***********************************************************************************************************************/
 ...
 */
#if (defined(EQT_BUILD))

    #define EQT_PUBLIC_API Q_DECL_EXPORT

#else

    #define EQT_PUBLIC_API Q_DECL_IMPORT

#endif

/** \def EQT_PUBLIC_TEMPLATE_METHOD
 * *
 ...
 */
    ...
    #define EQT_PUBLIC_TEMPLATE_METHOD __forceinline

#else

    #define EQT_PUBLIC_TEMPLATE_METHOD
