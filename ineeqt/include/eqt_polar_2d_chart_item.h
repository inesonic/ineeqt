...
* \file
*
* This header defines the \ref EQt::Polar2DChartItem class.
***********************************************************************************************************************/

/* .. sphinx-project ineeqt */

#ifndef EQT_POLAR_2D_CHART_ITEM_H
#define EQT_POLAR_2D_CHART_ITEM_H
...
namespace EQt {
    /**
     * Class that extends QPolarChart class (in the QtCharts frameworks) to address ownership management issues as well
     * as more cleanly handle insertion and removal from the graphics scene.
     */
    class EQT_PUBLIC_API Polar2DChartItem:public QPolarChart, public GraphicsItem {
        public:
            /**
             ...
             *
             * \param[in] windowFlags Windows flags to be used by the underlying QPolarChart instance.
             */
            Polar2DChartItem(QGraphicsItem* parent = Q_NULLPTR, Qt::WindowFlags windowFlags = Qt::WindowFlags());

            ~Polar2DChartItem() override;
